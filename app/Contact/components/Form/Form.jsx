...
export const Form = () => {
    ...
    return (
        <section className="contents container">
            ...
            <form action="#" className="contents__form" onSubmit={formSubmit}>

                <div className="contents__form__item">
                ...
                <div className="contents__form__policy">
                    <h3>
                        プライバシーポリシー
                    </h3>
                    <p>
                ...
                <div className="contents__form__checkbox">
